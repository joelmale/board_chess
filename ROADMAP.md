...
Build the full approved roadmap: harden the chess rules with tests, improve player UX, replace the IMGUI prototype with a 3D tabletop scene, add persistence, and finish Board SDK integration for physical glyph pieces. Target Unity `6000.4.5f1`.
...
4. `feat: build 3d chess board and pieces`
...
5. `feat: add responsive tabletop layout and captured pieces`
...
7. `feat: integrate board sdk glyph input`
...
8. `docs: update first-run and board deployment guide`
